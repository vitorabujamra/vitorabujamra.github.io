# [Now UI Dashboard](https://demos.creative-tim.com/now-ui-dashboard/pages/dashboard.html) [![Tweet](https://img.shields.io/twitter/url/http/shields.io.svg?style=social&logo=twitter)](https://twitter.com/home?status=Now%20UI%20Dashboard%20by%20Creative%20Tim%20https%3A//demos.creative-tim.com/now-ui-dashboard/pages/dashboard.html%20%40CreativeTim%20%23html%20%23dashboard%20%23nowuidesign%20%40creativetim)
...
**[Now UI Dashboard](https://demos.creative-tim.com/now-ui-dashboard/pages/dashboard.html)** is a responsive Bootstrap 4 kit provided for free by [Invision](https://www.invisionapp.com/) and [Creative Tim](https://www.creative-tim.com/). It combines colors that are easy on the eye, spacious cards, beautiful typography, and graphics. Now UI Dashboard comes packed with all plugins that you might need inside a project and documentation on how to get started. It is light and easy to use, and also very powerful.
...
- [Start page](https://demos.creative-tim.com/now-ui-dashboard/pages/dashboard.html)
- [Typography page](https://demos.creative-tim.com/now-ui-dashboard/pages/typography.html)
- [User page ](https://demos.creative-tim.com/now-ui-dashboard/pages/user.html)

[View More](https://demos.creative-tim.com/now-ui-dashboard/pages/dashboard.html).
...
## Resources
- [Live Preview](https://demos.creative-tim.com/now-ui-dashboard/pages/dashboard.html)
